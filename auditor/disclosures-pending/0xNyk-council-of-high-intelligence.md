<!--
Auto-prepared disclosure body for 0xNyk/council-of-high-intelligence.
The audit workflow's GITHUB_TOKEN cannot file issues on third-party
repos, so this body sits here pending manual filing:

  gh issue create --repo 0xNyk/council-of-high-intelligence \
    --title 'Security findings in executable artifacts' \
    --body-file auditor/disclosures-pending/0xNyk-council-of-high-intelligence.md

After filing, record the URL with:
  jq '.repos["0xNyk/council-of-high-intelligence"] += {disclosure_url: "<URL>", disclosure_filed_at: "<ISO8601>", disclosure_filed_by: "manual"}' \
...
Full audit report: https://github.com/xiaolai/nlpm/blob/main/auditor/audits/0xNyk-council-of-high-intelligence.md
